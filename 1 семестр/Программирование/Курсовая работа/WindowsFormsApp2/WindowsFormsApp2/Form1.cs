...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        static public void testP(int i, int j, int count) //координаты поля, номер для данного хода, поле (проверка стен,
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            {               
                ...
                //move.Parent = pictureBox1;
                //move.BackColor = Color.Transparent;
                //move.Location = new Point(351 + way[1, Second] * 30, 101 + way[0, Second] * 30);
                //move.Size = new Size(29, 29);
                //Controls.Add(move);
                //move.Text = "" + Second;
                //Second++;
                counter.Text = "" + Second;
